...
const Ptopiabox = (props) => {
  ...
  const [opacitydata, setOpacitydata] = useState(1);
  ...
  return (
    <div className="ptopiaboxouter">
      <div className="ptopiabox">
        ...
        <div
          className="ptopiabox-initial"
          onClick={() => setExpanded(!expanded)}
        >
          <div
            className="colored-rect"
            style={{ background: props.bckcolor }}
          ></div>
          ...
          <div className="data">
            ...
            <div className="ptopiabox-name">
              {props.yearly}%<div className="ptopiabox-text">Yearly</div>
            </div>
            <div className="ptopiabox-name">
              {props.daily}%<div className="ptopiabox-text">Daily</div>
            </div>
            <div className="ptopiabox-name">
              ${props.tvl}
        ...
        >
          ...
          <div id="ptopia-flex">
            <div className="wallet ptopia-box">
              <div className="wallet-line1">
                ...
                <span className="wallet-amount">
                  <span className="ptopiabox-name" id="pnvalue">
                    0.000000
                  </span>
              ...
              <div className="wallet-value">
                <input
                  ...
                  placeholder="0.00"
                  max={max2val}
                  value={max2 == 1 ? max2val : null}
                  min={0}
                />
                <span className="wallet-max-btn" onClick={() => setMax2(1)}>
                  Max
                </span>
              </div>
            ...
            <div className="wallet ptopia-box">
              ...
              <div className="get-ptopia" id="vault-get-ptopia">
                Get Ptopia
              </div>
              <div className="wallet-value">
                <input
          ...
          <div className="blackbox">
            ...
            <div className="blackbox-annual">
              ...
              <div className="bb-t">
                Swamp APR: <span className="bb-n">294.62%</span>
              </div>
              <div className="bb-t">
                Total Returns: <span className="bb-n">294.62%</span>
              </div>
            </div>
            <div className="blackbox-annual" id="bb-daily">
              <div className="bb-h1">Daily</div>
              <div className="bb-t">
                Swamp Daily: <span className="bb-n">294.62%</span>
              </div>
              <div className="bb-t">
                Total Daily: <span className="bb-n">294.62%</span>
              </div>
            </div>
            ...
            <div className="bb-right-links">
              <div className="bb-h1">
                ...
                <a className="bb-links" href="#">
                  Tutorials
                </a>
              </div>
              <div className="bb-h1">
                Check Fees & Takenomics{" "}
                <a className="bb-links" href="#">
                  Read docs
                </a>
              </div>
              <div className="bb-h1">
                <a className="bb-links" href="#" onClick={displayvault}>
                  Vault Details
                </a>
              </div>
            </div>
